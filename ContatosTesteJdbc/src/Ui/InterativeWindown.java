...
public class InterativeWindown  extends JFrame{
	...
	private void CriarFormulario()
	{
		...
		cadastroPanel.add(email);
		cadastroPanel.add(fieldEmail);
	...
	private class SalvarEvent implements ActionListener
	{
		public void actionPerformed(ActionEvent arg0)
		{
			try {
				...
				ContactPostgreSql contPg = new ContactPostgreSql();
				contPg.CreateContact(cont);
